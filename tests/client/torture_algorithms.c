...
static void torture_algorithms_sidhp434_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIDH_P434_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp256_sidhp434_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP256_SIDH_P434_SHA256, NULL, NULL);
}
static void torture_algorithms_sidhp434compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIDH_P434_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp256_sidhp434compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP256_SIDH_P434_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_sidhp610_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIDH_P610_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp384_sidhp610_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP384_SIDH_P610_SHA256, NULL, NULL);
}
static void torture_algorithms_sidhp610compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIDH_P610_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp384_sidhp610compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP384_SIDH_P610_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_sidhp751_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIDH_P751_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp521_sidhp751_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP521_SIDH_P751_SHA256, NULL, NULL);
}
static void torture_algorithms_sidhp751compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIDH_P751_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp521_sidhp751compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP521_SIDH_P751_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_sikep434_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIKE_P434_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp256_sikep434_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP256_SIKE_P434_SHA256, NULL, NULL);
}
static void torture_algorithms_sikep434compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIKE_P434_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp256_sikep434compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP256_SIKE_P434_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_sikep610_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIKE_P610_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp384_sikep610_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP384_SIKE_P610_SHA256, NULL, NULL);
}
static void torture_algorithms_sikep610compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIKE_P610_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp384_sikep610compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP384_SIKE_P610_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_sikep751_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIKE_P751_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp521_sikep751_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP521_SIKE_P751_SHA256, NULL, NULL);
}
static void torture_algorithms_sikep751compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_SIKE_P751_COMPRESSED_SHA256, NULL, NULL);
}
static void torture_algorithms_ecdh_nistp521_sikep751compressed_sha256(void** state)
{
    struct torture_state* s = *state;
    ...
    test_algorithm(s->ssh.session, KEX_ECDH_NISTP521_SIKE_P751_COMPRESSED_SHA256, NULL, NULL);
}
...
///// OQS_TEMPLATE_FRAGMENT_OQS_CASES_START
         ...
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp521_frodokem1344shake_sha512,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sidhp434_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp256_sidhp434_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sidhp434compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp256_sidhp434compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sidhp610_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp384_sidhp610_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sidhp610compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp384_sidhp610compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sidhp751_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp521_sidhp751_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sidhp751compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp521_sidhp751compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sikep434_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp256_sikep434_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sikep434compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp256_sikep434compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sikep610_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp384_sikep610_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sikep610compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp384_sikep610compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sikep751_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp521_sikep751_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_sikep751compressed_sha256,
                                         session_setup,
                                         session_teardown),
         cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_nistp521_sikep751compressed_sha256,
                                         session_setup,
                                         session_teardown),
