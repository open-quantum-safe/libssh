...
/* torture_algorithms_oqs_funcs.c is generated by oqs-generate.sh */
#include "torture_algorithms_oqs_funcs.c"
...
int torture_run_tests(void) {
    ...
    struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test_setup_teardown(torture_algorithms_ecdh_sha2_nistp521,
                                        ...
                                        session_teardown),
#endif
    /* torture_algorithms_oqs_cases.c is generated by oqs-generate.sh */
#include "torture_algorithms_oqs_cases.c"
    };
