...
#define KEX_NTRU_HPS2048509_SHA512 PQ_OQS_KEX_SUFFIX("ntru-hps2048509-sha512")
#define KEX_NTRU_HPS2048677_SHA512 PQ_OQS_KEX_SUFFIX("ntru-hps2048677-sha512")
#define KEX_NTRU_HPS4096821_SHA512 PQ_OQS_KEX_SUFFIX("ntru-hps4096821-sha512")
#define KEX_NTRU_HPS40961229_SHA512 PQ_OQS_KEX_SUFFIX("ntru-hps40961229-sha512")
#define KEX_NTRU_HRSS701_SHA512 PQ_OQS_KEX_SUFFIX("ntru-hrss701-sha512")
#define KEX_NTRU_HRSS1373_SHA512 PQ_OQS_KEX_SUFFIX("ntru-hrss1373-sha512")
...
#define KEX_NTRUPRIME_NTRULPR653_SHA256 PQ_OQS_KEX_SUFFIX("ntruprime-ntrulpr653-sha256")
#define KEX_NTRUPRIME_SNTRUP653_SHA256 PQ_OQS_KEX_SUFFIX("ntruprime-sntrup653-sha256")
#define KEX_NTRUPRIME_NTRULPR761_SHA384 PQ_OQS_KEX_SUFFIX("ntruprime-ntrulpr761-sha384")
#define KEX_NTRUPRIME_SNTRUP761_SHA384 PQ_OQS_KEX_SUFFIX("ntruprime-sntrup761-sha384")
#define KEX_NTRUPRIME_NTRULPR857_SHA384 PQ_OQS_KEX_SUFFIX("ntruprime-ntrulpr857-sha384")
#define KEX_NTRUPRIME_SNTRUP857_SHA384 PQ_OQS_KEX_SUFFIX("ntruprime-sntrup857-sha384")
#define KEX_NTRUPRIME_NTRULPR1277_SHA512 PQ_OQS_KEX_SUFFIX("ntruprime-ntrulpr1277-sha512")
#define KEX_NTRUPRIME_SNTRUP1277_SHA512 PQ_OQS_KEX_SUFFIX("ntruprime-sntrup1277-sha512")
...
#define KEX_ECDH_NISTP256_FRODOKEM_640_AES_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-frodokem-640-aes-sha256")
#define KEX_ECDH_NISTP384_FRODOKEM_976_AES_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-frodokem-976-aes-sha384")
#define KEX_ECDH_NISTP521_FRODOKEM_1344_AES_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-frodokem-1344-aes-sha512")
...
#define KEX_ECDH_NISTP256_KYBER_512_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-kyber-512-sha256")
#define KEX_ECDH_NISTP384_KYBER_768_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-kyber-768-sha384")
#define KEX_ECDH_NISTP521_KYBER_1024_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-kyber-1024-sha512")
#define KEX_ECDH_NISTP256_KYBER_512_90S_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-kyber-512-90s-sha256")
#define KEX_ECDH_NISTP384_KYBER_768_90S_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-kyber-768-90s-sha384")
#define KEX_ECDH_NISTP521_KYBER_1024_90S_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-kyber-1024-90s-sha512")
#define KEX_ECDH_NISTP256_BIKE_L1_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-bike-l1-sha512")
#define KEX_ECDH_NISTP384_BIKE_L3_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-bike-l3-sha512")
#define KEX_ECDH_NISTP256_NTRU_HPS2048509_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-ntru-hps2048509-sha512")
#define KEX_ECDH_NISTP384_NTRU_HPS2048677_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-ntru-hps2048677-sha512")
#define KEX_ECDH_NISTP521_NTRU_HPS4096821_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-ntru-hps4096821-sha512")
#define KEX_ECDH_NISTP521_NTRU_HPS40961229_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-ntru-hps40961229-sha512")
#define KEX_ECDH_NISTP384_NTRU_HRSS701_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-ntru-hrss701-sha512")
#define KEX_ECDH_NISTP521_NTRU_HRSS1373_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-ntru-hrss1373-sha512")
#define KEX_ECDH_NISTP256_CLASSIC_MCELIECE_348864_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-classic-mceliece-348864-sha256")
#define KEX_ECDH_NISTP256_CLASSIC_MCELIECE_348864F_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-classic-mceliece-348864f-sha256")
#define KEX_ECDH_NISTP384_CLASSIC_MCELIECE_460896_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-classic-mceliece-460896-sha512")
#define KEX_ECDH_NISTP384_CLASSIC_MCELIECE_460896F_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-classic-mceliece-460896f-sha512")
#define KEX_ECDH_NISTP521_CLASSIC_MCELIECE_6688128_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-classic-mceliece-6688128-sha512")
#define KEX_ECDH_NISTP521_CLASSIC_MCELIECE_6688128F_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-classic-mceliece-6688128f-sha512")
#define KEX_ECDH_NISTP521_CLASSIC_MCELIECE_6960119_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-classic-mceliece-6960119-sha512")
#define KEX_ECDH_NISTP521_CLASSIC_MCELIECE_6960119F_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-classic-mceliece-6960119f-sha512")
#define KEX_ECDH_NISTP521_CLASSIC_MCELIECE_8192128_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-classic-mceliece-8192128-sha512")
#define KEX_ECDH_NISTP521_CLASSIC_MCELIECE_8192128F_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-classic-mceliece-8192128f-sha512")
#define KEX_ECDH_NISTP256_HQC_128_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-hqc-128-sha256")
#define KEX_ECDH_NISTP384_HQC_192_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-hqc-192-sha384")
#define KEX_ECDH_NISTP521_HQC_256_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-hqc-256-sha512")
#define KEX_ECDH_NISTP256_NTRUPRIME_NTRULPR653_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-ntruprime-ntrulpr653-sha256")
#define KEX_ECDH_NISTP256_NTRUPRIME_SNTRUP653_SHA256 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp256-ntruprime-sntrup653-sha256")
#define KEX_ECDH_NISTP384_NTRUPRIME_NTRULPR761_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-ntruprime-ntrulpr761-sha384")
#define KEX_ECDH_NISTP384_NTRUPRIME_SNTRUP761_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-ntruprime-sntrup761-sha384")
#define KEX_ECDH_NISTP384_NTRUPRIME_NTRULPR857_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-ntruprime-ntrulpr857-sha384")
#define KEX_ECDH_NISTP384_NTRUPRIME_SNTRUP857_SHA384 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp384-ntruprime-sntrup857-sha384")
#define KEX_ECDH_NISTP521_NTRUPRIME_NTRULPR1277_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-ntruprime-ntrulpr1277-sha512")
#define KEX_ECDH_NISTP521_NTRUPRIME_SNTRUP1277_SHA512 HYBRID_ECDH_OQS_KEX_SUFFIX("ecdh-nistp521-ntruprime-sntrup1277-sha512")
