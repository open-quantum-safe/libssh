...
enum ssh_keytypes_e{
  ...
  /* Post-quantum and hybrid classical/PQ keytypes */
  SSH_KEYTYPE_OQSDEFAULT,
  SSH_KEYTYPE_DILITHIUM_2,
  SSH_KEYTYPE_FALCON_512,
  SSH_KEYTYPE_PICNIC_L1FULL,
  SSH_KEYTYPE_PICNIC3_L1,
#ifdef WITH_PQ_RAINBOW_ALGS
  SSH_KEYTYPE_RAINBOW_I_CLASSIC,
  SSH_KEYTYPE_RAINBOW_III_CLASSIC,
  SSH_KEYTYPE_RAINBOW_V_CLASSIC,
#endif
  SSH_KEYTYPE_SPHINCS_HARAKA_128F_ROBUST,
  SSH_KEYTYPE_SPHINCS_SHA256_128F_ROBUST,
  SSH_KEYTYPE_SPHINCS_SHAKE256_128F_ROBUST,
  SSH_KEYTYPE_RSA3072_OQSDEFAULT,
  SSH_KEYTYPE_P256_OQSDEFAULT,
  SSH_KEYTYPE_RSA3072_DILITHIUM_2,
  SSH_KEYTYPE_P256_DILITHIUM_2,
  SSH_KEYTYPE_RSA3072_FALCON_512,
  SSH_KEYTYPE_P256_FALCON_512,
  SSH_KEYTYPE_RSA3072_PICNIC_L1FULL,
  SSH_KEYTYPE_P256_PICNIC_L1FULL,
  SSH_KEYTYPE_RSA3072_PICNIC3_L1,
  SSH_KEYTYPE_P256_PICNIC3_L1,
#ifdef WITH_PQ_RAINBOW_ALGS
  SSH_KEYTYPE_RSA3072_RAINBOW_I_CLASSIC,
  SSH_KEYTYPE_P256_RAINBOW_I_CLASSIC,
  SSH_KEYTYPE_P384_RAINBOW_III_CLASSIC,
  SSH_KEYTYPE_P521_RAINBOW_V_CLASSIC,
#endif
  SSH_KEYTYPE_RSA3072_SPHINCS_HARAKA_128F_ROBUST,
  SSH_KEYTYPE_P256_SPHINCS_HARAKA_128F_ROBUST,
  SSH_KEYTYPE_RSA3072_SPHINCS_SHA256_128F_ROBUST,
  SSH_KEYTYPE_P256_SPHINCS_SHA256_128F_ROBUST,
  SSH_KEYTYPE_RSA3072_SPHINCS_SHAKE256_128F_ROBUST,
  SSH_KEYTYPE_P256_SPHINCS_SHAKE256_128F_ROBUST
#endif
};
